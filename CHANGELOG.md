...
- Made forward migrations 0001 and 0002 failure-atomic with explicit PostgreSQL transaction boundaries. Deterministic PostgreSQL 18.4 failure injection now proves 0001 cannot strand a partially secured generation table and 0002 cannot strand an admission function before PUBLIC EXECUTE revocation; clean replay restores each complete supported boundary while preserving earlier committed migrations.
