...
- TAXII collection polling, live MISP REST pull, or OpenCTI feed import (HTTP STIX/MISP document ingest is available at `POST /api/threat-intel/stix` and `POST /api/threat-intel/misp`)
