...
Current #435 is exact `6e528162328988547973a8a4f4aca9139b3d7761` on protected main, still Draft and mechanically mergeable. Production source is unchanged at this head. One-shot `Wardnet Coraza bounded repair` run `35414962707` and ordinary exact-head CI/security/SAST/CodeQL runs remain queued before usable production-candidate evidence. The runner-acquisition specimen is already central `.github#712` ownership; queue state is incomplete evidence and never justifies source churn, synthetic status, predecessor promotion, self/model approval or routine bypass.
