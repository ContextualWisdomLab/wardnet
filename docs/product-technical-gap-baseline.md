...
| --- | --- | --- | --- | --- | --- |
| unsigned-tag (this pass) | feat(release): refuse lightweight tags; pin k8s by digest | `feat/issue-84-unsigned-tag-admission` stacked on #108 | in progress | Author this pass | Org 2-approval + self-author. Merge #95…#99 then #105 then #106 then #107 then #108 first. Do not `--admin`. |
