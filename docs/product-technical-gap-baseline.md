...
| #95 in-path Coraza and accumulated production stack | `454f640b045ae26ad2b591d281bd8ee797de61d2` | `main` | Hickory CVEs, Clippy, DNS family cap, 406 interruption, baseline refresh, and four threads repaired; CodeQL/Devin plus independent approval required |
