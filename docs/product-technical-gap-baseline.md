...
Delegated CodeQL remains a central producer/receipt problem, not a Wardnet source problem on the unchanged consumer specimens. `.github#2028` was squash-merged into central protected `main@7fd571dbcdbae6acf29d8f4ee704d7ba6297e4db`, but its statusless fallback was subsequently rejected because it did not bind enough provenance. Canonical successor `.github#1902` is open/Ready and currently records exact head `1a3133f5efd147bc6892a2920749bf103f4683da`; its authenticated direct-evidence design still has an unresolved completeness finding because shard/coordinator/settlement job and artifact lookups stop at the first `per_page=100` response. Until that later-page RED→pagination repair reaches protected central truth, code-bearing Wardnet heads that fail only at delegated terminal-receipt reconciliation remain valid non-passing consumer evidence. Docs-only CodeQL success is not proof of the producer repair.
