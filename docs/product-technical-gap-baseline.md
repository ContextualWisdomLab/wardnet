...
Issue #442 / Draft #443 remains the response-streaming/backpressure lane at test-only exact `2cccfb37b85c3fc30d4b91d3027266feaf338774`. Historical hosted RED already proves whole-response buffering for delayed-tail, dishonest `Content-Length` and partial-upstream-failure cases. The current head adds slow-consumer/concurrent held-stream fixtures only; current CI `35921459298`, Security `35921459231`, SAST `35921459251` and CodeQL PR `35921459105` remain queued/pending. Production source repair stays serialized behind #435/#441/#140; #443 must not acquire the generic gateway source seam while #441 remains active.
