...
#441 is closed/merged; its exact source head `cd3c5985fd6317ab80c888fe1e37786f94d780e8` became #435 merge commit `534a48b54dcd9e668ceeec8d3d00f824531b0ad1`. Current #435 exact-head repository workflows are freshly materialized but not terminal: CI `35985049565`/`35984712559`, Fuzz `35985049520`/`35984712538`, Security `35984712490`, SAST `35984712601`, and CodeQL PR `35984712586` are queued. No predecessor GREEN is promoted across this merge.
...
Current #443 exact-head workflows are freshly materialized but not terminal: CI `35985182231`, Fuzz `35985182228`, Security `35985182193`, SAST `35985182196` are queued and CodeQL PR `35985182368` is pending. Historical RED is causal evidence only; current-head promotion evidence must be reacquired after the production repair.
