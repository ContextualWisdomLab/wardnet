...
That root movement invalidates all predecessor #129 workflow receipts as current evidence. Exact-current #129 repository lanes now show CI `34884595676` **SUCCESS**, Fuzz `34884595640` **SUCCESS**, and SAST Semgrep `34884595634` **SUCCESS`; Security Scan `34884595678` and CodeQL PR `34884595690` remain **QUEUED**. Treat queued evidence as incomplete and do not transfer predecessor GREEN or central verdict conclusions to this head.
