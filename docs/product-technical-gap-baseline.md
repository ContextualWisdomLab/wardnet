...
| --- | --- | --- | --- | --- | --- |
| runtime-role (this pass) | feat(store): non-owner PostgreSQL runtime role | `feat/issue-80-runtime-role` stacked on #100 | in progress | Author this pass | Org 2-approval + self-author. Merge #95 then #96 then #97 then #98 then #99 then #100 first. Do not `--admin`. |
