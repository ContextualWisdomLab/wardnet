...
Keep #129 source stable on exact `9e90a4abbd42e3a790ba51c460e4b35e11042e1c` while its fresh root gates settle. CI `34665569341`, Security Scan `34665569296`, and SAST `34665569460` are GREEN; Fuzz `34665569378` is still executing; required CodeQL `34665569493` reproduced the central current-head verdict/release failure before a successful downstream dispatch. Route that exact tuple through `.github#1929` and its live successor #2040 rather than leaf source churn, blind reruns, synthetic status or bypass.
