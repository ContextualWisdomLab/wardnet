...
**Architecture:** One Rust workspace. The root crate remains the web-managed gateway and deployment unit. `crates/wardnet-core` contains deterministic domain logic that future Coraza, Suricata, MISP, TAXII, DNS, and AI SOC adapters can reuse.
...
- [x] Add `crates/wardnet-core` and move pure domain logic into it.
