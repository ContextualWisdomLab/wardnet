...
#[test]
fn approved_pip_install_cannot_inherit_unreviewed_force_reinstall_authority() {
...
fn approved_pip_install(executable: &str) -> (AdmissionPolicy, InstallIntent) {
    ...
    let policy = AdmissionPolicy {
        ...
        policy_revision: "2026-09-11.6".to_string(),
    ...
    let intent = InstallIntent {
        request_id: format!("req-{executable}-force-reinstall-authority"),
