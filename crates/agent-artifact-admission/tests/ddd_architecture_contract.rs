...
const DOMAIN_SOURCES: &[(&str, &str)] = &[
    ...
    (
        "artifact_source_identity.rs",
        include_str!("../src/artifact_source_identity.rs"),
    ),
    (
        "artifact_variant.rs",
        include_str!("../src/artifact_variant.rs"),
    ),
    ("oci_transport.rs", include_str!("../src/oci_transport.rs")),
